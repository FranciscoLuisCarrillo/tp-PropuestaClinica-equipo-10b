...
<asp:Content ID="Main" ContentPlaceHolderID="MainContent" runat="server">
    <main class="container my-4" role="main" aria-labelledby="titulo-medicos">
        ...
        <!-- LISTADO -->
        <asp:Panel ID="pnlListadoMedicos" runat="server"
           ClientIDMode="Static"
           CssClass="card shadow-sm mb-4">
        ...
        <asp:Panel ID="pnlNuevoMedico" ClientIDMode="Static" runat="server" CssClass="card shadow-sm mb-4" Style="display:none;">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-sm btn-outline-secondary" onclick="ocultarFormularioMedico()">
                    Cancelar
                </button>
            </div>
            ...
            <div class="card-body">
                <asp:ValidationSummary ID="ValidarMedico" runat="server"
                    CssClass="alert alert-danger mb-3" EnableClientScript="true" />
                ...
                <div class="mb-3">
                    ...
                    <div class="border rounded p-2">
                        <asp:CheckBoxList ID="chkEspecialidades" data-rol="especialidades"
                            runat="server" CssClass="form-check" RepeatDirection="Vertical" />
                    </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    <button type="button" class="btn btn-outline-secondary" onclick="ocultarFormularioMedico()">
                        Cancelar
                    </button>
                    <asp:Button ID="btnGuarda" runat="server"
                        Text="Guardar médico" CssClass="btn btn-success"
                        OnClick="btnGuarda_Click" />
                </div>
            </div>
        </asp:Panel>
