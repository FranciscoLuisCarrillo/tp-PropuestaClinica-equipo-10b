            ...
            <div class="card-body p-4">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlEspecialidades" ErrorMessage="Seleccioná especialidad" CssClass="text-danger small" Display="Dynamic" />
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlHora" ErrorMessage="Hora requerida" CssClass="text-danger small" Display="Dynamic" />
                    </div>
                    ...
                    <div class="col-12 text-end mt-4">
                        ...
                        <asp:Button ID="btnCrearTurno" runat="server" Text="Confirmar Reserva" CssClass="btn btn-success px-4" OnClick="btnCrearTurno_Click" />
                    </div>
                </div>
            </div>
        </div>
